...
\subsection{Densities}
  ...
  given by 
  ``$(e_1,\dots,e_n) \mapsto (T\varphi \cdot e_1, \dots, T\varphi \cdot e_n)$''. \ram{this is unclear, what is $\phi$ versus $\Phi$ and what is $T$.}
  ...
  \begin{thm} \label{thm:advection}
    ...
    \end{enumerate}
\ram{may want to cite the coordinate versions of each as well to make clear the distinction...}
  \end{thm}
  \begin{proof}
