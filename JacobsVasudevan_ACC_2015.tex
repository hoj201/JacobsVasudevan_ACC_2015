...
in regions near the origin.  A typical advection is shown in 
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.23\textwidth]{./images/vdp_t0p0.png}
  \includegraphics[width=0.23\textwidth]{./images/vdp_t0p30.png}
  \includegraphics[width=0.23\textwidth]{./images/vdp_t0p64.png}
  \includegraphics[width=0.23\textwidth]{./images/vdp_t0p97.png}
