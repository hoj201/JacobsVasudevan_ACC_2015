...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{abstract}
  Consider the task of computing a probability density advected by an 
  autonomous dynamical system.
  Existing schemes exhibit numerical artifacts such as negative probability densities and fairly weak convergence results if any.
  In this article we present a method whith a relatively strong
  convergence result, which also preseves the sign of densities.
  Moreover, we use dense charts to transport the machinary of wavelet analysis to manifolds.
  This allows us to implement our method on a variety of non-Euclidean spaces at multiple length scales.
\end{abstract}
...
\label{sec:scheme}
  ...
  \end{align*}
  This is the content of theorem \ref{thm:convergence}, to which
  the next subsection is devoted.
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.2\textwidth]{./images/half_density_sqr_t1_00.png}
  \includegraphics[width=0.2\textwidth]{./images/half_density_sqr_t2_00.png}
  \includegraphics[width=0.2\textwidth]{./images/transfer_op_t1_00.png}
  \includegraphics[width=0.2\textwidth]{./images/transfer_op_t2_00.png}
